...
const userNavigation = [
  { name: 'Your Profile', href: '/profileData' },
  { name: 'Settings', href: '#' },
  { name: 'Sign out', href: '#' },
]
...
export default function NavigationDashboard({ children }: any) {
  return (
    <>
      {/*
                ...
                <div className="flex items-center justify-between h-16">
                  <div className="flex items-center">
                    ...
                    <div className="hidden md:block">
                      <div className="ml-10 flex items-baseline space-x-4 nav_links ">
                        {navigation.map((item) => (
                          <Link
                            key={item.name}
                            href={item.href}
                  ...
                  <div className="hidden md:block">
                    <div className="ml-4 flex items-center md:ml-6">
                      ...
                      {/* Profile dropdown */}
                      <Menu as="div" className="ml-3 relative icon ">
                        <div>
            ...
            <main>
              <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                ...
                <div className="px-4 py-4 sm:px-0">
                  <div className="border-4 border-dashed border-gray-200 rounded-lg h-96 h-full">
                    {/* <Campaigns session={session} /> */}
                  </div>
                </div>
                {/* /End replace */}
              </div>
